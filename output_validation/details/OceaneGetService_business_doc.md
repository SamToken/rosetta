...
- ⚠️ **Gap de logique**
  - Point de décision — is_array('valueRelatedParty'['actionInProgress']) et key_exists('description', 'valueRelatedParty'['actionInProgress'])) return 'valueRelatedParty'['actionInProgress']['description']; } } } } } return null; } public function getActifGroup(. Quel est le comportement attendu dans le cas contraire ?
- ⚠️ **Gap de logique**

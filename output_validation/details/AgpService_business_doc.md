...
- [ ] initAgp.md5 : cette méthode de protection est-elle une contrainte documentée ?
- [ ] initAgp.session : l'habilitation est-elle vérifiée par un service centralisé ?
- [ ] initAgp.session_key : cette clé est-elle nettoyée dans tous les chemins de sortie ?
- [ ] initAgp.data : L'état du ticket est lu depuis Oceane en temps réel à cette étape — 3 cas non...
- [ ] initAgp.maitreDeport : Le code situation 'ok' est hardcodé — vient-il d'une table de référence Oracle ?
- [ ] initAgp.maitreDeport : Le code situation 'nok' est hardcodé — vient-il d'une table de référence Orac...
- [ ] initAgp.typeRessource : Le code situation 'DSLAM' est hardcodé — vient-il d'une table de référence Or...
- [ ] initAgp.typeRessource : Le code situation 'MIE' est hardcodé — vient-il d'une table de référence Orac...
- [ ] initAgp.typeRessource : Le code situation 'SLN' est hardcodé — vient-il d'une table de référence Orac...
- [ ] initAgp.typeRessource : Le code situation 'COMMUT' est hardcodé — vient-il d'une table de référence O...
- [ ] initAgp.data : Le code situation 'HO' est hardcodé — vient-il d'une table de référence Oracle ?
- [ ] initAgp.data : Le code situation 'HNO' est hardcodé — vient-il d'une table de référence Orac...
- [ ] initAgp.data : Le code situation 'DiagSDH' est hardcodé — vient-il d'une table de référence ...
- [ ] initAgp.input : Le code situation 'alarme' est hardcodé — vient-il d'une table de référence O...
- [ ] initAgp.data : Le code situation 'TRCCABLE' est hardcodé — vient-il d'une table de référence...
- [ ] initAgp.data : Le code situation 'SDH' est hardcodé — vient-il d'une table de référence Orac...
- [ ] initAgp.keyVariable : Le code situation 'CODE_EAN' est hardcodé — vient-il d'une table de référence...
- [ ] initAgp.keyTag : Le code situation 'ean' est hardcodé — vient-il d'une table de référence Orac...
- [ ] initAgp.dataTag : Le code situation 'True' est hardcodé — vient-il d'une table de référence Ora...
- [ ] initAgp.keyVariable : Le code situation 'Types' est hardcodé — vient-il d'une table de référence Or...
...
### Questions ouvertes pour arbitrage
- [ ] displayAgp1.md5 : cette méthode de protection est-elle une contrainte documentée ?
- [ ] displayAgp1.session : l'habilitation est-elle vérifiée par un service centralisé ?
- [ ] displayAgp1.session_key : cette clé est-elle nettoyée dans tous les chemins de sortie ?
- [ ] displayAgp1.data : L'état du ticket est lu depuis Oceane en temps réel à cette étape — 3 cas non...
...
- [ ] displayAgp1.typeRessource : Le code situation 'MIE' est hardcodé — vient-il d'une table de référence Orac...
- [ ] displayAgp1.typeRessource : Le code situation 'SLN' est hardcodé — vient-il d'une table de référence Orac...
- [ ] displayAgp1.typeRessource : Le code situation 'COMMUT' est hardcodé — vient-il d'une table de référence O...
- [ ] displayAgp1.data : Le code situation 'HO' est hardcodé — vient-il d'une table de référence Oracle ?
- [ ] displayAgp1.data : Le code situation 'HNO' est hardcodé — vient-il d'une table de référence Orac...
- [ ] displayAgp1.data : Le code situation 'DiagSDH' est hardcodé — vient-il d'une table de référence ...
- [ ] displayAgp1.input : Le code situation 'alarme' est hardcodé — vient-il d'une table de référence O...
- [ ] displayAgp1.data : Le code situation 'TRCCABLE' est hardcodé — vient-il d'une table de référence...
- [ ] displayAgp1.data : Le code situation 'SDH' est hardcodé — vient-il d'une table de référence Orac...
- [ ] displayAgp1.keyVariable : Le code situation 'CODE_EAN' est hardcodé — vient-il d'une table de référence...
- [ ] displayAgp1.keyTag : Le code situation 'ean' est hardcodé — vient-il d'une table de référence Orac...
- [ ] displayAgp1.dataTag : Le code situation 'True' est hardcodé — vient-il d'une table de référence Ora...
- [ ] displayAgp1.keyVariable : Le code situation 'Types' est hardcodé — vient-il d'une table de référence Or...
...
### Questions ouvertes pour arbitrage
- [ ] displayCreationTocTrans.md5 : cette méthode de protection est-elle une contrainte documentée ?
...
- [ ] displayCreationTocTrans.donnesTempsReel : Le code situation 'ok' est hardcodé — vient-il d'une table de référence Oracle ?
- [ ] displayCreationTocTrans.keyVariable : Le code situation 'CODE_EAN' est hardcodé — vient-il d'une table de référence...
- [ ] displayCreationTocTrans.keyTag : Le code situation 'ean' est hardcodé — vient-il d'une table de référence Orac...
- [ ] displayCreationTocTrans.dataTag : Le code situation 'True' est hardcodé — vient-il d'une table de référence Ora...
- [ ] displayCreationTocTrans.keyVariable : Le code situation 'Types' est hardcodé — vient-il d'une table de référence Or...
- [ ] displayCreationTocTrans.astroData : Le code situation 'DSLAM' est hardcodé — vient-il d'une table de référence Or...

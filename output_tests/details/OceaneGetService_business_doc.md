# OceaneGetServiceController — Règles Métier
...
- ⚠️ **Gap de logique**
  - Point de décision — is_array('value') et key_exists('index', 'value') et !is_null('id') et (intval('value'['index']) égal à 'id') et key_exists('value', 'value'). Quel est le comportement attendu dans le cas contraire ?
- ⚠️ **Gap de logique**
  - Point de décision — is_array('value') et key_exists('index', 'value') et key_exists('value', 'value'). Quel est le comportement attendu dans le cas contraire ?
- ⚠️ **Gap de logique**
...
- ⚠️ **Gap de logique**
  - Point de décision — 'idAndName'. Quel est le comportement attendu dans le cas contraire ?
- ⚠️ **Gap de logique**
...
- ⚠️ **Gap de logique**
  - Point de décision — is_array('value') et key_exists('index', 'value') et !is_null('champ') et (intval('value'['index']) égal à 'champ') et key_exists('value', 'value'). Quel est le comportement attendu dans le cas contraire ?
- ⚠️ **Gap de logique**
...
- ⚠️ **Gap de logique**
  - Point de décision — 'idAndLabel'. Quel est le comportement attendu dans le cas contraire ?
- ⚠️ **Gap de logique**
...
- ⚠️ **Gap de logique**
  - Point de décision — !is_null('format'). Quel est le comportement attendu dans le cas contraire ?
- ⚠️ **Gap de logique**
